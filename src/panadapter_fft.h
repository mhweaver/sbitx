...
void panadapter_fft_push(struct panadapter_fft *context,
	const double *i_samples, const double *q_samples, int count);
void panadapter_fft_request(struct panadapter_fft *context,
	const struct panadapter_fft_config *config);
bool panadapter_fft_get_frame(struct panadapter_fft *context,
	const struct panadapter_fft_config *config,
