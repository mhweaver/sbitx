...
int main(void) {
  ...
  assert(panadapter_grid_step_hz(14700) == 2000);
  assert(panadapter_grid_step_hz(12500) == 2000);
  assert(panadapter_grid_step_hz(2200) == 200);
  assert(panadapter_grid_step_hz(704) == 100);
  assert(panadapter_grid_step_hz(3000) == 250);
  ...
  assert(panadapter_view_frequency_x(10, 400, 14074800, 14073000, 3000) == 250);
  assert(panadapter_view_frequency_x(10, 400, 14070000, 14073000, 3000) == 10);
  assert(panadapter_view_frequency_x(10, 400, 14080000, 14073000, 3000) == 410);
